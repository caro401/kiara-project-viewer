...
export abstract class KiaraContext {
  ...
  public abstract render_value(
    value: string,
    render_config: Record<string, any>
  ): Promise<RenderValueResult>;

  public abstract list_aliases(
    matcher?: ValueMatcher
  ): Promise<Record<string, Value>>;

  public abstract list_values(
    matcher?: ValueMatcher
  ): Promise<Record<string, Value>>;

  public abstract get_alias_names(data_type?: string): Promise<string[]>;

  public abstract get_aliases_info(
    matcher?: ValueMatcher
  ): Promise<Record<string, ValueInfo>>;

  public abstract get_alias_names_for_types(
    data_types: string[]
  ...
  public abstract validate_inputs(
    ...
    inputs_schema: Record<string, ValueSchema>
  ): Promise<Record<string, string>>;

  public abstract queue_job(
    operation_id: string,
    inputs: Record<string, any>,
...
export class KiaraRestClientContext extends KiaraContext {
  ...
  public async get_alias_names_for_types(
    data_types: string[]
  ): Promise<Record<string, string[]>> {
